...
const AudioProcessor = dynamic(
  () => import("@/components/identify/audio/AudioProcessor"),
  {
    ssr: false,
...
const ImageProcessor = dynamic(
  () => import("@/components/identify/images/ImageProcessor"),
  {
    ssr: false,
    loading: () => <div>Cargando...</div>,
  }
...
export default function IdentifyPage() {
  ...
  return (
    <div
      className="min-h-screen flex flex-col items-center text-center sm:p-10 shadow-lg
